...
export async function POST(req: NextRequest) {
  try {
    ...
    "src/app/auth/page.tsx": r'''"use client"
...
export default function AuthPage() {
  return (
    ...
    "src/components/Navbar.tsx": r''''use client';
...
export default function Navbar() {
  ...
  return (
    ...
    "src/app/globals.css": r'''@import "tailwindcss";
...
@media (prefers-reduced-motion: reduce) { *, *::before, *::after { animation-duration: 0.01ms !important; animation-iteration-count: 1 !important; transition-duration: 0.01ms !important; scroll-behavior: auto !important; } }''',
    ...
    "python-backend/main.py": r'''import os
import threading
...
async def process_video(req: ProcessRequest):
    ...
    "src/app/api/clips/generate/route.ts": r'''import { NextRequest, NextResponse } from 'next/server'
...
print("Selesai. Jangan lupa restart Next.js dan Python.")
