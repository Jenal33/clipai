# Base folder project ClipAI
BASE_DIR = "/home/je3393/clipai"

FILES_TO_FIX = {}

# ===== FILE 1: [...nextauth]/route.ts =====
FILES_TO_FIX["src/app/api/auth/[...nextauth]/route.ts"] = r"""import NextAuth, { NextAuthOptions } from "next-auth"
  ...
  providers: [
    CredentialsProvider({
      ...
      async authorize(credentials) {
        ...
        if (!allowed) throw new Error(`Terlalu banyak percobaan. Coba lagi dalam ${retryAfterSec} detik.`)
        ...
        if (!user.emailVerified) throw new Error("Email belum diverifikasi. Cek inbox/spam kamu untuk link verifikasi.")
...
# ===== FILE 2: owner-login/route.ts =====
FILES_TO_FIX["src/app/api/auth/owner-login/route.ts"] = r"""import { NextRequest, NextResponse } from 'next/server'
import { prisma } from '@/lib/prisma'
...
# ===== FILE 3: auth/page.tsx =====
FILES_TO_FIX["src/app/auth/page.tsx"] = r'''"use client"
...
# ===== FILE 4: Navbar.tsx =====
FILES_TO_FIX["src/components/Navbar.tsx"] = """'use client';
...
# ===== FILE 5: globals.css =====
FILES_TO_FIX["src/app/globals.css"] = """@import "tailwindcss";
...
# ===== FILE 6: main.py =====
FILES_TO_FIX["python-backend/main.py"] = """import os
import threading
...
# ===== FILE 7: generate/route.ts =====
FILES_TO_FIX["src/app/api/clips/generate/route.ts"] = """import { NextRequest, NextResponse } from 'next/server'
...
print("\nSelesai! Restart Next.js + Python backend.")
